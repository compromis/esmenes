...
<amendable id="1_3" title="Participació">
...
Des de Joves PV, som conscients que, per tal de fer front a aquesta nova situació hem de deixar clares les relacions que volem establir tant en el plànol intern com a l’extern, és a dir, les entitats que defensen, de manera concreta i específica, les línies ideològiques de la nostra organització: defensa dels drets de les persones joves, del valencianisme, dels drets laborals i socials, de l’ecologisme, del feminisme i de l’antifeixisme. 
...
<amendable-section id="2_1" title="Relacions amb Més-Compromís" level="3">
<amendable id="2_1_0">
...
<amendable-section id="2_2" title="Relacions amb Compromís" level="3">
<amendable id="2_2_0">
...
Com a organització juvenil de referència en Compromís, apostem per la unitat de Compromís i la superació de les actuals estructures, per ser així, des del territori, una eina eficaç i capaç d'encapçalar el progressisme al País Valencià.

Així mateix, hem de tenir en compte les altres dues organitzacions juvenils que existeixen a Compromís (Joves amb Iniciativa  i Joves VerdsEquo PV) amb les quals hem de tenir una relació coordinada en els espais que així es determine.

</amendable>
</amendable-section>
<amendable-section id="2_3" title="Relacions amb entitats de la societat civil" level="3">
<amendable id="2_3_0">
...
<amendable id="2_3_1" title="Entitats que defensen els drets de les persones joves">
...
Hem d'aglutinar els nostres esforços en continuar tenint una persona representant a la Comissió Permanent del Consell Valencià de la Joventut, com a símbol de la nostra lluita i compromís pels drets de les persones joves.
...
<amendable id="2_3_2" title="Entitats que defensen els drets laborals i socials">

La situació actual de l’habitatge i del mercat laboral es troba en una situació insostenible per a la joventut. El nivell de precarització dels treballs i la impossibilitat d’accés a un habitatge ens porta, com a organització juvenil, a buscar afinitats amb altres organitzacions amb trajectòria i una base consolidada en la defensa dels drets laborals i socials com Joves CCOO PV, Intersindical Jove.
...
Pel que fa a l'habitatge, ens fixem en entitats com la plataforma València no està en venda i altres plataformes municipals semblants i els sindicats de llogaters i llogateres, que són espais junt als quals és important intentar treballar, així com altres amb un recorregut anterior com la Plataforma d'Afectades per la Hipoteca (PAH).

També cal tractar com a joventuts la qüestió de la salut mental, que actualment està al focus mediàtic i ocupa lloc en els debats polítics i socials. Per això, entenem que estrényer llaços amb entitats com la Federació Salut Mental CV és necessari per a crear el nostre argumentari sobre aquestes matèries. Igualment, és important comptar amb els col·legis professionals com a ponents a les nostres formacions en aquesta matèria per tal d’ampliar els nostres coneixements sobre aquests temes tan necessaris i integrar-ho en els nostres plans d'acció.

Així mateix, considerem d'extrema necessitat fer esment a la diversitat cultural. Considerem que Joves PV és i ha de continuar sent una representació real de la diversitat i, per això, cal reforçar els nostres llaços amb entitats com CEA(R) 

</amendable>
<amendable id="2_3_3" title="Entitats que defensen el valencianisme">

En l'àmbit del valencianisme, considerem molt important mantindre una bona relació amb totes les entitats i una relació d'estreta cooperació amb l'ACV Tirant lo Blanc i la Fundació Nexe. A més, trobem que Acció Cultural del País Valencià-- Joves d'Acció, JovesXValencià, Escola Valenciana i Plataforma per la llengua són organitzacions amb les quals hem de mantindre una relació de cordialitat. De fet, cal destacar el treball conjunt que es fa amb aquestes entitats, de manera especial amb Joves d’Acció durant els últims mesos.
...
En l'àmbit continental i coherents amb la nostra defensa de l'Europa dels pobles s'establiran de manera prioritària relacions amb aquelles organitzacions d'esquerres integrants de les joventuts de l'Aliança Lliure Europea Jove (EFAY). També en l'àrea de relacions internacionals hem de mantindre relació amb aquelles associacions, fundacions i organitzacions no governamentals que tinguen com a eix central del seu treball la defensa dels drets humans i del dret a l'autodeterminació dels pobles, com per exemple aquelles vinculades a la defensa de la causa de Palestina i el CEAS SÀHARA (Frente Polisario).
...
<amendable id="2_3_4" title="Entitats feministes">
...
<amendable id="2_3_5" title="Entitats ecologistes">
...
<amendable id="2_3_6" title="Entitats que defensen la diversitat">
...
L'estratègia comunicativa i la imatge que es transmet s’ha de tractar conjuntament amb el convenciment i els principis ideològics que li donen forma, evitant fer campanyes buides de contingut polític. És per això que l’activitat política s'haurà de coordinar amb l'acció comunicativa, amb l’objectiu que el pensament polític de Joves PV tinga la major i millor difusió possible.
...
De fet, el paper de les persones joves en la comunicació és més que important. Per això, Joves PV ha de ser, com ve sent, una organització referent en les estratègies comunicatives. Per tot això, proposem que les estratègies de comunicació de Joves PV seguisquen el camí de la professionalització de l'acció comunicativa i l'amplificació del seu impacte.

Els principals canals de comunicació en xarxes socials seran Instagram (un canal ja consolidat) i Tiktok (en què hem de seguir treballant per créixer). L’estratègia es dividirà en tres eixos principals: el primer serà la creació de contingut per a dies simbòlics de la nostra organització (9 d’octubre, 8M, 25N, Orgull LGTBIQ+…); el segon eix serà apostar per la comunicació continua i actualitzada, amb publicacions i vídeos de contingut polític d’actualitat o per fer oposició aprofitant les nostres diputades, regidores i alcaldesses; i el tercer serà l’elaboració de campanyes centrades en diferents temàtiques d’importància per a la joventut.

A més a més, caldrà una coordinació activa entre l’àrea de Comunicació de la Coordinadora Nacional de Joves PV i el personal tècnic de Comunicació del Més i Compromís per a afavorir el treball i combinar les estratègies comunicatives de cada un.

Per tindre l'impacte més gran possible i tindre un major abast caldrà fer publicacions conjuntes amb els càrrecs públics de Joves PV i de Compromís , ja que això possibilitarà una major difusió. Igualment, hem de tindre cura quan decidim fer col·laboracions amb altres perfils, doncs tampoc hem de deixar de banda el posicionament de Joves PV i posar en valor en nostre treball sense diluir-lo amb altres perfils.

</amendable>


<amendable id="3_1" title="Professionalització">
...
Per a això és important seguir el manual d'estil de Joves PV a l'hora de produir contingut, però també cuidar la formes de producció d'este seguint una identitat cooperativa determinada. El manual indicarà els colors corporatius que s'han d'usar, les tipografies i les normes per al disseny dels materials. I també, serà necessari cuidar els missatges produïts revisant sempre la seua ortografia i la seua construcció lingüística correcta.

Cal destacar que, des de Joves PV hi ha ferramentes a disposició dels col·lectius comarcals i locals per facilitat la coordinació en xarxes socials: les targes. És important destacar que el seu ús transmet harmonització, donat que aquestes targes compten amb un estil que respecta el Manual d’identitat visual de la nostra organització i segueix una línia gràfica. Aquestes targes s’han de modificar i adaptar per tal que no queden obsoletes. És per això que cal incidir en mantenir el seu ús. 
...
<amendable id="3_2" title="Amplificació">
...
A més a més, una conseqüència indirecta d’un major impacte serà el creixement dels seguidors i els m’agrada, és a dir, enfocar-se en aquestes i aconseguir augmentar-les, farà que el suport del compte també puge. No obstant això, un número no defineix la qualitat de les publicacions que es fa, per aquest motiu, els seguidors i seguidores i els m’agrada no poden ser una bona ferramenta per a conéixer com estan funcionant les publicacions i el que les tendències comunicatives del moment ens demanen, la qual cosa sí que es podrà estudiar amb les interaccions.

</amendable>

<amendable id="3_3" title="Actualització de la pàgina web">

Cal tindre en compte que no sols s’ha d’apostar per les xarxes socials o mitjans de comunicació. En aquest aspecte, és important tindre un web amb informació rellevant i actualitzada. Aquest web és el lloc d’aterratge on arriben aquelles persones que s’interessen per conéixer més la nostra organització.

En aquest sentit, des de l’àrea de comunicació s’ha d’aprofitar aquesta ferramenta. Una de les maneres per a dur-ho a terme és actualitzant la informació en les diferents seccions, així com les imatges i vídeos. De la mateixa manera, els diferents col·lectius, siguen comarcals o locals, han de tindre un espai on publicar i compartir diferents notícies, ja siga accedint a la pàgina web amb un usuari i una contrasenya o mitjançant alguna persona responsable de la Coordinadora Comarcal. 
...
<amendable id="4_1" title="Context">

La nostra estratègia electoral ha de sorgir, necessàriament, de la comprensió de la realitat que vivim al País Valencià actualment. En el nostre darrer Congrés Nacional veníem de la pèrdua del govern de la Generalitat en mans de la dreta i l’extrema-dreta, però la situació política ha canviat de manera significativa l’últim any. La DANA i la gestió negligent del govern de la Generalitat han sigut elements indispensables per entendre el panorama electoral en el context previ al nostre VI Congrés Nacional.

La nostra organització ha viscut un paper visible i actiu en les protestes contra el govern de Carlos Mazón, prioritzant la mobilització als carrers com a mecanisme per bastir una estratègia política. La mobilització del conjunt de la societat ha conduït a la dimissió de Mazón i a un procés d’interinatge al capdavant del govern valencià, que Joves PV - Compromís ha de denunciar. Hem de significar-nos com l’alternativa política al model fallit del PP i Vox.

</amendable>
<amendable id="4_2" title="El model de Joves PV">

En aquest context, el paper de les persones joves ha de ser clau. Enfront de les dades que indiquen un viratge ideològic de la joventut cap a posicions més properes als postulats de la dreta, Joves PV hem de ser capaços d’il·lusionar i mobilitzar l’electorat jove d’esquerra valencianista. Només així, mitjançant la proposta i la il·lusió, serem capaços de recuperar la nostra força electoral.

Així doncs, s’ha de construir un model alternatiu, en què Joves PV parle de les problemàtiques que preocupen a les persones joves: accés a l’habitatge, transport públic o precarietat, entre d’altres. I ho podrem fer mitjançant l’elaboració de campanyes polítiques, les qual hauran de connectar, necessàriament, l’acció als carrers i als mitjans de comunicació i xarxes socials.

En resum, la crisi de Mazón ha obert una escletxa per reforçar la nostra presència, legitimitat i missatge entre la joventut valenciana. Per això hem de tindre la capacitat de canalitzar aquesta mobilització en una proposta estructurada i electoralment viable, posicionant-nos com a actor fonamental del futur de Compromís i de la política valenciana. 
...
En el cas de les les Corts Valencianes, comptem amb una diputada  per la circumscripcions d’Alacant, i no comptem amb cap representant a les Diputacions Provincials. Durant estos últims dos anys, un diputat autonòmic i una diputada provincial que eren joves, han deixat de ser-ho i això ens demostra que hem de continuar avançant en la creació de nous lideratges i la nostra implantació entre les persones més joves.   

Cal tindre en compte que la població valenciana d’entre 19 i 30 anys representa més d’un 11% del total i això, de cara a les futures cites electorals, s’ha de notar amb major presència a les Corts Valencianes, a les Diputacions i als ajuntaments. Quan recuperem la Generalitat Valenciana també haurem d’estar presents, les persones joves, als càrrecs de govern.

Tota aquesta xarxa institucional, per tant, ha de comptar amb una estratègia institucional que ha d'estar coordinada i que depèn de la Coordinadora Nacional de Joves PV, la qual haurà de promoure la creació d'espais de coordinació política entre els càrrecs i el personal eventual jove d'institucions com el Congrés i Senat, el Parlament Europeu, lles Corts, les Diputacions o els ajuntaments amb els òrgans de direcció de Joves PV.

</amendable>

<amendable id="5_1" title="Coordinació municipal">
...
Continuant amb la coordinació entre regidors i regidores joves, cal aprofundir en la creació d’espais formatius tant administratius com comunicatius que ens ajuden a millorar els nostres lideratges. Cal fer més estrets els lligams entre regidors i regidores, ja siga per que comparteixen govern o oposició o per la proximitat entre els seus pobles. 

Per a coordinar l’acció en clau municipalista i amb la vista posada en les elecciones de 2027, cal crear l’Assemblea Municipalista, un espai que es convoque periòdicament per la Coordinadora Nacional on regidors, regidores i secretaries comarcals es puguen reunir per tal d'intercanviar experiències, teixir complicitats i establir estratègies. 

També s'ha de continuar apostant per una Trobada Municipalista periòdica com a espai amable, de compartir experiències, d'aprendre i fer xarxa per a afrontar tots els reptes que tenim en aquesta legislatura. 

Per acabar, la formació de les persones regidores juga un paper molt important i Joves PV ha de procurar-la tant en matèria administrativa com comunicativament, tant per a les persones amb responsabilitats de govern com per a les persones que han de desenvolupar les tasques d'oposició. Així, i en col·laboració amb el Més, s’han elaborat jornades de formació per a regidores. No obstant això, caldria un pla de formació més específic o establir trobades municipalistes on es tracten temes i/o problemàtiques concretes (estatuts dels membres de les corporacions locals, grups polítics, elecció de l'alcalde/ssa, qüestions pràctiques sobre la sessió constitutiva i organitzativa, àrees de govern i delegacions, règim de funcionament de la Junta de Govern, Comissions Informatives i Ple, competències dels ajuntaments…)

</amendable>

<amendable id="5_2" title="Coordinació Supramunicipal">
...
Tanmateix, la coordinació supramunicipal, no depèn exclusivament dels càrrecs de Joves PV, sinó que també hem de fer valdre la resta de càrrecs per tal de desenvolupar polítiques de joventut perquè són transversals. 
...
<amendable id="6_1" title="Estratègia orgànica">
...
<amendable id="6_2" title="Estratègia política">
